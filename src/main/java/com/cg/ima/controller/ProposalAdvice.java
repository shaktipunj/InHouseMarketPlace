...
public class ProposalAdvice {
	
	@ExceptionHandler(InvalidProposalException.class)
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public ErrorMessageDto handleNotFoundException(InvalidProposalException exception)
	{
		return new ErrorMessageDto(ProposalConstant.PROPOSAL_NOT_FOUND,HttpStatus.NOT_FOUND.toString());
	}
